...
var ApplicationConfiguration = (function () {
  ...
  var applicationModuleVendorDependencies = ['ngResource', 'ngAnimate', 'ngMessages', 'ui.router', 'ui.bootstrap', 'ui.utils', 'angularFileUpload', 'angularTypewrite'];
  ...
  function routeConfig($stateProvider) {
    $stateProvider
      ...
      .state('pictures.view', {
        ...
        data:{
          pageTitle: 'Picture {{ articleResolve.name }}'
        }
      });
  }
...
(function () {
  ...
  PicturesController.$inject = ['$scope', '$state', 'Authentication', 'pictureResolve'];

  function PicturesController ($scope, $state, Authentication, picture) {
    var vm = this;
